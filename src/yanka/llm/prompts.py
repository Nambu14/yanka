...
Do not include raw_input or clarifying_exchange — the application stores the session transcript."""
...
- Never set raw_input or clarifying_exchange (application fills verbatim session transcript)
